...
if __name__ == '__main__':
    ...
    with open("key_features_Lincolnshire.csv", "w") as csvfile:

        writer = csv.writer(csvfile)
        writer.writerow(["id"])

        for i in range(1, 226):
            url = 'https://www.zoopla.co.uk/for-sale/property/lincolnshire/?identifier=lincolnshire&pagesize=25&q=LINCOLNSHIRE&search_source=refine&radius=0&pn='+str(i)
